#include "NOR_Storage.h"


void NOR_Storage::init(String name, GT_U7_GPS* gps)
{
...
void NOR_Storage::init_evr_file()
{
...
void NOR_Storage::write_line(char filename[13], String dataString)
{
...
void NOR_Storage::write_evr(String type, String subsystem, String note)
{
...
void NOR_Storage::read(char filename[13])
{
...
void NOR_Storage::remove_all_files()
{
